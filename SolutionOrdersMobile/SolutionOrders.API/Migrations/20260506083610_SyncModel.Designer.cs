...
namespace SolutionOrders.API.Migrations
{
    ...
    [Migration("20260506083610_SyncModel")]
            ...
            modelBuilder.Entity("SolutionOrders.API.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdCategory = 1,
                            Description = "Żeliwo przede wszystkiem",
                            IsActive = true,
                            Name = "Złom"
                        },
                        new
            ...
            modelBuilder.Entity("SolutionOrders.API.Models.Client", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdClient = 1,
                            Adress = "ul. Gostyńska 1, Rembertów",
                            IsActive = true,
                            Name = "Adam Ostolski",
                            PhoneNumber = "700-100-200"
                        },
                        new
                        {
                            IdClient = 2,
                            Adress = "ul. Miarowa 5, Garwolin",
                            IsActive = true,
                            Name = "Tomasz Pochwatka",
                            PhoneNumber = "900-200-300"
                        });
                });
            ...
            modelBuilder.Entity("SolutionOrders.API.Models.Item", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdItem = 1,
                            Code = "TRA001",
                            Description = "Miedź najwyższej jakości",
                            IdCategory = 1,
                            IdUnitOfMeasurement = 1,
                            IsActive = true,
                            Name = "Trakacja De Lux",
                            Price = 9500m,
                            Quantity = 12m
                        },
                        new
                        {
                            IdItem = 2,
                            Code = "POD001",
                            Description = "Stal z Rzeszowa",
                            IdCategory = 2,
                            IdUnitOfMeasurement = 1,
                            IsActive = true,
                            Name = "Podkład Standard",
                            Price = 7800m,
                            Quantity = 25m
                        });
                });
