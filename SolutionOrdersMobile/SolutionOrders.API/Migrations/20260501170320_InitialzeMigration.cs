...
{
    /// <inheritdoc />
    public partial class InitialzeMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Żeliwo przede wszystkiem", true, "Złom" },
                    { 2, "Miedź", true, "Trakcje" },
                    { 3, "Stal", true, "Podkłady kolejowe" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "ul. Gostyńska 1, Rembertów", true, "Adam Ostolski", "700-100-200" },
                    { 2, "ul. Miarowa 5, Garwolin", true, "Tomasz Pochwatka", "900-200-300" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Andrzej", true, "Burlkowski", "Burlik123", "haszlo123" },
                    { 2, "Karol", true, "Nowakowski", "Know", "haslo456" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "TRA001", "Miedź najwyższej jakości", null, 1, 1, true, "Trakacja De Lux", 9500m, 12m },
                    { 2, "POD001", "Stal z Rzeszowa", null, 2, 1, true, "Podkład Standard", 7800m, 25m }
                });
