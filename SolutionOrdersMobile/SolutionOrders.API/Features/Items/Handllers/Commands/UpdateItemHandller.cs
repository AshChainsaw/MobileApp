...
{
    public class UpdateItemHandller : IRequestHandler<UpdateItemCommand, Unit>
    {
        private readonly ApplicationDbContext _context;
        private readonly ILogger<UpdateItemHandller> _logger;

        public UpdateItemHandller(
            ApplicationDbContext context,
            ILogger<UpdateItemHandller> logger)
        {
            _context = context;
            _logger = logger;
        }
